...
def vGenerateTrainerWEvent(eventID, items=0,levels=[50,50],party_size=[3,6],name_variable=1,class_variable=2,gender_variable=3,event_variable=4)
...
# Sets the event ID to a random generated trainer
def vGenerateTrainer(items=0,levels=[50,50],party_size=[3,6],name_variable=1,class_variable=2,gender_variable=3,event_variable=4)
  # Check for event viability
  # return false if eventID.nil? || (!eventID.is_a?(Integer) && !eventID.is_a?(Game_Event))
  # Set the event
  # event = nil
